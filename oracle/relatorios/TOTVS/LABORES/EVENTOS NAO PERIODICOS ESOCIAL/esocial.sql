...
FROM   (SELECT pfunc.chapa,
        ...
        FROM   U_CFL8U4_RM.pesocialeventos
               LEFT JOIN U_CFL8U4_RM.pfuncpreliminar
                      ON pesocialeventos.idregpreliminar = pfuncpreliminar.idregistro
               LEFT JOIN U_CFL8U4_RM.pfunc
                      ON pfuncpreliminar.chapa = pfunc.chapa
               LEFT JOIN U_CFL8U4_RM.ppessoa
       ...
       LEFT JOIN U_CFL8U4_RM.psecao
              ON tab1.codsecao = psecao.codigo
       LEFT JOIN U_CFL8U4_RM.gfilial
              ON psecao.codfilial = gfilial.codfilial
WHERE  tab1.dt_envio >= :data
/*
                                                                             WHERE
