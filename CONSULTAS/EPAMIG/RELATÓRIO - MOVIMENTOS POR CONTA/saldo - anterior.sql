               ...
               FROM   (SELECT codtmv,
                              ...
                              ( CASE
                                  ...
                                  WHEN codtmv LIKE '2%'
                                       AND codtmv NOT IN ( '2.2.01', '2.2.02', '2.2.07', '2.2.08',
                                                           '2.2.09', '2.2.21', '2.2.22', '2.2.14', '2.2.47' )
                                       AND SUM(TRUNC(valorfincomsinal, 2)) < 0 THEN TRUNC(SUM(valorbrutoitem), 2) * ( -1 )
                                  WHEN codtmv LIKE '2%'
                                       AND codtmv NOT IN ( '2.2.01', '2.2.02', '2.2.07', '2.2.08',
                                                           '2.2.09', '2.2.21', '2.2.22', '2.2.14', '2.2.47' )
                       ...
                       FROM   (SELECT codtmv,
                               ...
                               FROM   U_CFL8U4_RM.trelsld
                                      JOIN U_CFL8U4_RM.tmov
                                        ON ( tmov.idmov = trelsld.idmov )
                               ...
                               /* WHERE
                                    ...
                                    AND trelsld.codfilial <= 1 */
                               WHERE  TRELSLD.DATAMOVIMENTO < '01/01/2020'
